...
func (x *WebDetection) Reset() {
	*x = WebDetection{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[0]
...
func (*WebDetection) Descriptor() ([]byte, []int) {
	return file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescGZIP(), []int{0}
}
...
func (x *WebDetection_WebEntity) Reset() {
	*x = WebDetection_WebEntity{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WebDetection_WebEntity) Descriptor() ([]byte, []int) {
	return file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *WebDetection_WebImage) Reset() {
	*x = WebDetection_WebImage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WebDetection_WebImage) Descriptor() ([]byte, []int) {
	return file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *WebDetection_WebPage) Reset() {
	*x = WebDetection_WebPage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WebDetection_WebPage) Descriptor() ([]byte, []int) {
	return file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *WebDetection_WebLabel) Reset() {
	*x = WebDetection_WebLabel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WebDetection_WebLabel) Descriptor() ([]byte, []int) {
	return file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescGZIP(), []int{0, 3}
}
...
var file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x70, 0x33, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x57, 0x65, 0x62, 0x44, 0x65, 0x74,
	...
	0x6e, 0x2e, 0x76, 0x31, 0x70, 0x33, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x57, 0x65, 0x62, 0x44,
	...
	0x33, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x57, 0x65, 0x62, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74,
	...
	0x70, 0x33, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x57, 0x65, 0x62, 0x44, 0x65, 0x74, 0x65, 0x63,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x70, 0x33, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x57,
	...
	0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x70, 0x33, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x57, 0x65, 0x62,
	...
	0x6f, 0x75, 0x64, 0x2f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x2f, 0x76, 0x31, 0x70, 0x33, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x3b, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0xf8, 0x01, 0x01, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescOnce sync.Once
	file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescData = file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDesc
)

func file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescGZIP() []byte {
	file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescOnce.Do(func() {
		file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescData)
	})
	return file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDescData
}

var file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_cloud_vision_v1p3beta1_web_detection_proto_goTypes = []interface{}{
	(*WebDetection)(nil),           // 0: google.cloud.vision.v1p3beta1.WebDetection
	(*WebDetection_WebEntity)(nil), // 1: google.cloud.vision.v1p3beta1.WebDetection.WebEntity
	(*WebDetection_WebImage)(nil),  // 2: google.cloud.vision.v1p3beta1.WebDetection.WebImage
	(*WebDetection_WebPage)(nil),   // 3: google.cloud.vision.v1p3beta1.WebDetection.WebPage
	(*WebDetection_WebLabel)(nil),  // 4: google.cloud.vision.v1p3beta1.WebDetection.WebLabel
}
var file_google_cloud_vision_v1p3beta1_web_detection_proto_depIdxs = []int32{
	1, // 0: google.cloud.vision.v1p3beta1.WebDetection.web_entities:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebEntity
	2, // 1: google.cloud.vision.v1p3beta1.WebDetection.full_matching_images:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebImage
	2, // 2: google.cloud.vision.v1p3beta1.WebDetection.partial_matching_images:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebImage
	3, // 3: google.cloud.vision.v1p3beta1.WebDetection.pages_with_matching_images:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebPage
	2, // 4: google.cloud.vision.v1p3beta1.WebDetection.visually_similar_images:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebImage
	4, // 5: google.cloud.vision.v1p3beta1.WebDetection.best_guess_labels:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebLabel
	2, // 6: google.cloud.vision.v1p3beta1.WebDetection.WebPage.full_matching_images:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebImage
	2, // 7: google.cloud.vision.v1p3beta1.WebDetection.WebPage.partial_matching_images:type_name -> google.cloud.vision.v1p3beta1.WebDetection.WebImage
...
func init() { file_google_cloud_vision_v1p3beta1_web_detection_proto_init() }
func file_google_cloud_vision_v1p3beta1_web_detection_proto_init() {
	if File_google_cloud_vision_v1p3beta1_web_detection_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_vision_v1p3beta1_web_detection_proto_goTypes,
		DependencyIndexes: file_google_cloud_vision_v1p3beta1_web_detection_proto_depIdxs,
		MessageInfos:      file_google_cloud_vision_v1p3beta1_web_detection_proto_msgTypes,
	}.Build()
	File_google_cloud_vision_v1p3beta1_web_detection_proto = out.File
	file_google_cloud_vision_v1p3beta1_web_detection_proto_rawDesc = nil
	file_google_cloud_vision_v1p3beta1_web_detection_proto_goTypes = nil
	file_google_cloud_vision_v1p3beta1_web_detection_proto_depIdxs = nil
}
