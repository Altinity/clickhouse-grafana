    ...
    return {
        ...
        execute: function () {
            ...
            ace.define("ace/mode/clickhouse_info", ["require", "exports", "module"], function (require, exports, module) {
                ...
                var p = {};
                p.Keywords = ["SELECT", "CASE", "THEN", "DISTINCT", "INSERT", "UPDATE", "DELETE", "WHERE", "AND", "OR", "OFFSET", "HAVING", "AS", "FROM", "WHEN", "ELSE", "END", "TYPE", "LEFT", "RIGHT", "USING", "JOIN", "ON", "OUTER", "DESC", "ASC", "UNION", "CREATE", "TABLE", "PRIMARY", "KEY", "FOREIGN", "NOT", "REFERENCES", "DEFAULT", "INNER", "CROSS", "NATURAL", "DATABASE", "DROP", "GRANT", "ANY", "BETWEEN", "ATTACH", "DETACH", "CAST", "WITH", "BIT_AND", "BIT_OR", "BIT_XOR", "DESCRIBE", "OPTIMIZE", "PREWHERE", "TOTALS", "DATABASES", "PROCESSLIST", "SHOW", "IF", "IF NOT EXISTS", "IF EXISTS", "GROUP BY", "ORDER BY", "UNION ALL", "FORMAT JSON", "FORMAT JSONCompact", "FORMAT JSONEachRow", "FORMAT TSV", "FORMAT TabSeparated", "FORMAT TabSeparatedWithNames", "FORMAT TabSeparatedWithNamesAndTypes", "FORMAT TabSeparatedRaw", "FORMAT BlockTabSeparated", "FORMAT TSKV", "FORMAT CSV", "FORMAT CSVWithNames", "SYSTEM RELOAD DICTIONARY", "SYSTEM RELOAD DICTIONARIES", "SYSTEM DROP DNS CACHE", "SYSTEM SHUTDOWN", "SYSTEM KILL", "CLEAR COLUMN IN PARTITION"];
                ...
                p.Macros = ["$table", "$timeCol", "$dateTimeCol", "$from", "$to", "$interval", "$timeFilter", "$timeSeries", "$rate", "$columns", "$rateColumns"];
