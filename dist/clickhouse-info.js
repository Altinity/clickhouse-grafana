    ...
    return {
        ...
        execute: function () {
            ...
            ace.define("ace/mode/clickhouse_info", ["require", "exports", "module"], function (require, exports, module) {
                ...
                var p = {};
                p.Keywords = ["select", "from", "where", "prewhere", "having", "order", "group", "limit", "format", "union", "by", "all", "right", "left", "any", "global", "in", "not", "offset", "type", "inner", "outer", "desc", "asc", "between", "foreign", "default", "null", "show", "attach", "detach", "describe", "optimize", "using"];
