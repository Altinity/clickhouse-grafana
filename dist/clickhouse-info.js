            ...
            ace.define("ace/mode/clickhouse_info", ["require", "exports", "module"], function (require, exports, module) {
                ...
                p.MacrosCompletions = function () {
                    return [{
                        ...
                        "name": "$perSecond",
                        "def": "$perSecond(cols...)",
                        "docText": "Similar to $rate macros for Counter-like type of metrics which are only grow. The macros will chose the max" + "value for each column in every timeSlot and calculate the changes." + "\n" + "Example:\n $perSecond(total_requests) FROM requests"
                    }, {
...
//# sourceMappingURL=clickhouse-info.js.map
