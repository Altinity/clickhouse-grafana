...
* 3 [Plugin Installation](#plugin-installation)
    ...
    * 3.4 [Grafana Datasource Plugin For ClickHouse](#grafana-datasource-plugin-for-clickhouse)
        * 3.4.1 [RQ.SRS.Plugin](#rqsrsplugin)
    * 3.5 [Adding New Data Source](#adding-new-data-source)
        * 3.5.1 [RQ.SRS.Plugin.DataSourceSetupView ](#rqsrsplugindatasourcesetupview-)
        * 3.5.2 [RQ.SRS.Plugin.DataSourceSetupView.SaveAndTestButton](#rqsrsplugindatasourcesetupviewsaveandtestbutton)
    * 3.6 [Specifying Data Source Name](#specifying-data-source-name)
        * 3.6.1 [RQ.SRS.Plugin.DataSourceSetupView.DataSourceName](#rqsrsplugindatasourcesetupviewdatasourcename)
    * 3.7 [Using Default Data Source](#using-default-data-source)
        * 3.7.1 [RQ.SRS.Plugin.DataSourceSetupView.DefaultDataSource](#rqsrsplugindatasourcesetupviewdefaultdatasource)
    * 3.8 [Specifying HTTP Connection](#specifying-http-connection)
        * 3.8.1 [RQ.SRS.Plugin.DataSourceSetupView.HTTPConnection](#rqsrsplugindatasourcesetupviewhttpconnection)
    * 3.9 [Connecting to the Local Clickhouse Server](#connecting-to-the-local-clickhouse-server)
        * 3.9.1 [RQ.SRS.Plugin.DataSourceSetupView.HTTPConnection.ServerAccess](#rqsrsplugindatasourcesetupviewhttpconnectionserveraccess)
    * 3.10 [Connecting to the Remote Clickhouse Server](#connecting-to-the-remote-clickhouse-server)
        * 3.10.1 [RQ.SRS.Plugin.DataSourceSetupView.HTTPConnection.BrowserAccess](#rqsrsplugindatasourcesetupviewhttpconnectionbrowseraccess)
    * 3.11 [ClickHouse Authentification Setup](#clickhouse-authentification-setup)
        * 3.11.1 [RQ.SRS.Plugin.DataSourceSetupView.Auth](#rqsrsplugindatasourcesetupviewauth)
    * 3.12 [ClickHouse Authentification Setup Using Username And Password](#clickhouse-authentification-setup-using-username-and-password)
        * 3.12.1 [RQ.SRS.Plugin.DataSourceSetupView.BasicAuth](#rqsrsplugindatasourcesetupviewbasicauth)
    * 3.13 [ClickHouse Authentification Setup Using TLS/SSL Auth Details](#clickhouse-authentification-setup-using-tlsssl-auth-details)
        * 3.13.1 [RQ.SRS.Plugin.DataSourceSetupView.TLS/SSLAuthDetails](#rqsrsplugindatasourcesetupviewtlssslauthdetails)
    * 3.14 [ClickHouse Authentification Using Forward OAuth Identity](#clickhouse-authentification-using-forward-oauth-identity)
        * 3.14.1 [RQ.SRS.Plugin.DataSourceSetupView.ForwardOAuthIdentity](#rqsrsplugindatasourcesetupviewforwardoauthidentity)
    * 3.15 [Sending Credentials Setup](#sending-credentials-setup)
        * 3.15.1 [RQ.SRS.Plugin.DataSourceSetupView.WithCredentials](#rqsrsplugindatasourcesetupviewwithcredentials)
    * 3.16 [ClickHouse Authentification With CA Certificate](#clickhouse-authentification-with-ca-certificate)
        * 3.16.1 [RQ.SRS.Plugin.DataSourceSetupView.Auth.WithCACert](#rqsrsplugindatasourcesetupviewauthwithcacert)
    * 3.17 [Specifying Custom HTTP Headers](#specifying-custom-http-headers)
        * 3.17.1 [RQ.SRS.Plugin.DataSourceSetupView.CustomHTTPHeaders](#rqsrsplugindatasourcesetupviewcustomhttpheaders)
        * 3.17.2 [RQ.SRS.Plugin.DataSourceSetupView.DeletingCustomHTTPHeaders](#rqsrsplugindatasourcesetupviewdeletingcustomhttpheaders)
    * 3.18 [Connection To Managed Yandex.Cloud ClickHouse Database Setup](#connection-to-managed-yandexcloud-clickhouse-database-setup)
        * 3.18.1 [RQ.SRS.Plugin.DataSourceSetupView.UseYandexCloudAuthorizationHeaders](#rqsrsplugindatasourcesetupviewuseyandexcloudauthorizationheaders)
    * 3.19 [Specifying Use CORS Flag In Requests](#specifying-use-cors-flag-in-requests)
        * 3.19.1 [RQ.SRS.Plugin.DataSourceSetupView.AddCORSFlagToRequests](#rqsrsplugindatasourcesetupviewaddcorsflagtorequests)
    * 3.20 [Specifying Use POST Requests](#specifying-use-post-requests)
        * 3.20.1 [RQ.SRS.Plugin.DataSourceSetupView.UsePostRequests](#rqsrsplugindatasourcesetupviewusepostrequests)
    * 3.21 [Specifying Default Database](#specifying-default-database)
        * 3.21.1 [RQ.SRS.Plugin.DataSourceSetupView.DefaultDatabase](#rqsrsplugindatasourcesetupviewdefaultdatabase)
    * 3.22 [Creating Dashboards](#creating-dashboards)
        * 3.22.1 [RQ.SRS.Plugin.Dashboards](#rqsrsplugindashboards)
    * 3.23 [Creating Panels](#creating-panels)
        * 3.23.1 [RQ.SRS.Plugin.Panels](#rqsrspluginpanels)
    * 3.24 [Multi-user usage](#multi-user-usage)
        * 3.24.1 [RQ.SRS.Plugin.MultiUserUsage](#rqsrspluginmultiuserusage)
    * 3.25 [Query Setup](#query-setup)
        * 3.25.1 [RQ.SRS.Plugin.QuerySetup](#rqsrspluginquerysetup)
    * 3.26 [Query Setup Interface](#query-setup-interface)
        * 3.26.1 [RQ.SRS.Plugin.QuerySetupInterface](#rqsrspluginquerysetupinterface)
    * 3.27 [Query Options](#query-options)
        * 3.27.1 [RQ.SRS.Plugin.QueryOptions](#rqsrspluginqueryoptions)
    * 3.28 [Raw SQL Editor](#raw-sql-editor)
        * 3.28.1 [RQ.SRS.Plugin.RawSQLEditorInterface](#rqsrspluginrawsqleditorinterface)
    * 3.29 [Time range selector](#time-range-selector)
        * 3.29.1 [RQ.SRS.Plugin.TimeRangeSelector](#rqsrsplugintimerangeselector)
    * 3.30 [Refresh Databoard](#refresh-databoard)
        * 3.30.1 [RQ.SRS.Plugin.RefreshDataboard](#rqsrspluginrefreshdataboard)
    * 3.31 [Inspecting Query](#inspecting-query)
        * 3.31.1 [RQ.SRS.Plugin.QueryInspector](#rqsrspluginqueryinspector)
        * 3.31.2 [RQ.SRS.Plugin.QueryInspector.QueryTab](#rqsrspluginqueryinspectorquerytab)
    * 3.32 [Vizualization](#vizualization)
        * 3.32.1 [RQ.SRS.Plugin.Vizualization](#rqsrspluginvizualization)
        * 3.32.2 [Table View](#table-view)
            * 3.32.2.1 [RQ.SRS.Plugin.Vizualization.Table](#rqsrspluginvizualizationtable)
        * 3.32.3 [Visualization Types](#visualization-types)
            * 3.32.3.1 [RQ.SRS.Plugin.Vizualization.VisualizationTypes](#rqsrspluginvizualizationvisualizationtypes)
    * 3.33 [Macroces](#macroces)
        * 3.33.1 [RQ.SRS.Plugin.QuerySettings.Macroses](#rqsrspluginquerysettingsmacroses)
    * 3.34 [Functions](#functions)
        * 3.34.1 [RQ.SRS.Plugin.Functions](#rqsrspluginfunctions)
    * 3.35 [Supported types](#supported-types)
        * 3.35.1 [RQ.SRS.Plugin.SupportedTypes](#rqsrspluginsupportedtypes)
    * 3.36 [Versions Compatibility](#versions-compatibility)
        * 3.36.1 [RQ.SRS.Plugin.VersionCompatibility](#rqsrspluginversioncompatibility)
