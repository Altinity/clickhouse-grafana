...
* 29 [Time range selector](#time-range-selector)
    * 29.1 [RQ.SRS.Plugin.TimeRangeSelector](#rqsrsplugintimerangeselector)
* 30 [Refresh Databoard](#refresh-databoard)
    * 30.1 [RQ.SRS.Plugin.RefreshDataboard](#rqsrspluginrefreshdataboard)
* 31 [Inspecting Query](#inspecting-query)
    * 31.1 [RQ.SRS.Plugin.QueryInspector](#rqsrspluginqueryinspector)
    * 31.2 [RQ.SRS.Plugin.QueryInspector.QueryTab](#rqsrspluginqueryinspectorquerytab)
* 32 [Vizualization](#vizualization)
    * 32.1 [RQ.SRS.Plugin.Vizualization](#rqsrspluginvizualization)
    * 32.2 [Table View](#table-view)
        * 32.2.1 [RQ.SRS.Plugin.Vizualization.Table](#rqsrspluginvizualizationtable)
    * 32.3 [Visualization Types](#visualization-types)
        * 32.3.1 [RQ.SRS.Plugin.Vizualization.VisualizationTypes](#rqsrspluginvizualizationvisualizationtypes)
* 33 [Macroces](#macroces)
    * 33.1 [RQ.SRS.Plugin.QuerySettings.Macroses](#rqsrspluginquerysettingsmacroses)
* 34 [Functions](#functions)
    * 34.1 [RQ.SRS.Plugin.Functions](#rqsrspluginfunctions)
* 35 [Supported types](#supported-types)
