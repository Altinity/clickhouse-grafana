...
class Locators:
    ...
    def extrapolation_toggle(self, query_name, grafana_version=None):
        ...
        if not(grafana_version is None) and (int(grafana_version.split(".")[0]) <= 10):
            ...
            search_class = "data-rfd-draggable-id"
        return driver.find_element(SelectBy.XPATH, f'//*[contains(@{search_class}, "{query_name}")]//*[./text()="Extrapolation"]/..//*[contains(@for,"switch")]')
    ...
    def add_metadata_toggle(self, query_name, grafana_version=None):
        ...
        if not(grafana_version is None) and (int(grafana_version.split(".")[0]) <= 10):
            ...
            search_class = "data-rfd-draggable-id"
        return driver.find_element(SelectBy.XPATH, f'//*[contains(@{search_class}, "{query_name}")]//*[./text()="Add metadata"]/..//*[contains(@for,"switch")]')
    ...
    def show_generated_sql_button(self, query_name, grafana_version=None):
        ...
        if not(grafana_version is None) and (int(grafana_version.split(".")[0]) <= 10):
            ...
            search_class = "data-rfd-draggable-id"
        return driver.find_element(SelectBy.XPATH, f'//*[contains(@{search_class}, "{query_name}")]//button[.//text()="Show generated SQL"]')
