...
def get_help_text(self, query_name):
    ...
    return locators.help_macros(query_name=query_name, grafana_version=self.context.grafana_version).text + locators.help_functions(
      query_name=query_name, grafana_version=self.context.grafana_version).text
