...
def click_extrapolation_toggle(self, query_name):
    ...
    locators.extrapolation_toggle(query_name=query_name).click()
...
def enter_step(self, step, query_name):
    ...
    locators.step_textfield(query_name=query_name).clear()
    locators.step_textfield(query_name=query_name).send_keys(step)
    locators.step_textfield(query_name=query_name).send_keys(Keys.ENTER)
...
def enter_resolution(self, resolution, query_name):
    ...
    locators.resolution_dropdown(query_name=query_name).send_keys(resolution)
    locators.resolution_dropdown(query_name=query_name).send_keys(Keys.ENTER)
...
def enter_format_as(self, format_as, query_name):
    ...
    locators.format_as_dropdown(query_name=query_name).send_keys(format_as)
    locators.format_as_dropdown(query_name=query_name).send_keys(Keys.ENTER)
...
def click_add_metadata_toggle(self, query_name):
    ...
    locators.add_metadata_toggle(query_name=query_name).click()
...
def click_skip_comments_toggle(self, query_name):
    ...
    locators.skip_comments_toggle(query_name=query_name).click()
...
def enter_round(self, round, query_name):
    ...
    locators.round_textfield(query_name=query_name).clear()
    locators.round_textfield(query_name=query_name).send_keys(round)
    locators.round_textfield(query_name=query_name).send_keys(Keys.ENTER)
...
def click_show_help_button(self, query_name):
    ...
    locators.show_help_button(query_name=query_name).click()
...
def click_show_generated_sql_button(self, query_name):
    ...
    locators.show_generated_sql_button(query_name=query_name).click()
...
def get_reformatted_query(self, query_name):
    ...
    return locators.reformatted_query(query_name=query_name).text
...
def get_time_from_in_seconds(self, query_name):
    ...
    reformatted_query = locators.reformatted_query(query_name=query_name).text
...
def get_help_text(self, query_name):
    ...
    return locators.help_macros(query_name=query_name).text + locators.help_functions(query_name=query_name).text
...
def get_step_text(self, query_name):
    ...
    return locators.step_textfield(query_name=query_name).get_attribute('value')
...
def get_round_text(self, query_name):
    ...
    return locators.round_textfield(query_name=query_name).get_attribute('value')